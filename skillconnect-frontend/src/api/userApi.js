  ...
  async login(credentials) {
    try {
      ...
      if (response.data && response.data.token) {
        ...
        // Get user data to store profile image
        ...
        if (userData.profileImageUrl) {
          ...
          localStorage.setItem("userImage", "https://t4.ftcdn.net/jpg/02/15/84/43/360_F_215844325_ttX9YiIIyeaR7Ne6EaLLjMAmy4GvPC69.jpg");
        }
      }
      return response.data;
    } catch (error) {
